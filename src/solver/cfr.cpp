...
void addReachProbsToArray(std::array<double, StandardDeckSize>& villainReachProbWithCard, int villainHandIndex, double villainReachProb, const TraversalConstants& constants, const Tree& tree) {
